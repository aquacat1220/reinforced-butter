...
CHECKPOINT_PATH = "results/checkpoints/1753437972__exit_env_v0__exit_env_lstm_5050_long_w_stupid_preview_4__1/iter_10000.pt"
NUM_ENVS = 128
...
writer = SummaryWriter(f"results/eval/stupid/")
win_count = 0
lose_count = 0
total_count = 0
global_step = 0
